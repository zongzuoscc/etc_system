    ...
    content: vue.withCtx(() => [
      _ctx.multiple ? (vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.createElementVNode("li", {
          ...
          onClick: ($event) => _ctx.handleSelect(null, 0)
        }, vue.toDisplayString(_ctx.t("el.table.clearFilter")), 11, ["tabindex", "aria-checked", "onClick"]),
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.filters, (filter, idx) => {
          ...
          }, vue.toDisplayString(filter.text), 11, ["tabindex", "aria-checked", "onClick"]);
        }), 128))
      ], 42, ["onKeydown"]))
    ]),
    default: vue.withCtx(() => {
