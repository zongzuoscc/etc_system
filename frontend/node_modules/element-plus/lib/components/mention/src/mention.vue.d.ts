...
declare const __VLS_component: import("vue").DefineComponent<{
    ...
    type: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => string) | (() => import("element-plus/es/components/input").InputType) | ((new (...args: any[]) => string) | (() => import("element-plus/es/components/input").InputType))[], unknown, unknown, "text", boolean>;
    resize: {
    ...
    offset: number;
    id: string;
    type: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => string) | (() => import("element-plus/es/components/input").InputType) | ((new (...args: any[]) => string) | (() => import("element-plus/es/components/input").InputType))[], unknown, unknown>;
