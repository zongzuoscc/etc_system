            ...
            vue.createElementVNode("div", {
              ...
              vue.createElementVNode("div", {
                ...
                _ctx.unlinkPanels ? (vue.openBlock(), vue.createElementBlock("button", {
                  key: 0,
                  type: "button",
                  disabled: !vue.unref(enableYearArrow) || vue.unref(dateRangeDisabled),
                  class: vue.normalizeClass([[
                    vue.unref(ppNs).e("icon-btn"),
                    vue.unref(ppNs).is("disabled", !vue.unref(enableYearArrow) || vue.unref(dateRangeDisabled))
                  ], "d-arrow-right"]),
                ...
                _ctx.unlinkPanels && vue.unref(leftCurrentView) === "date" ? (vue.openBlock(), vue.createElementBlock("button", {
                  key: 1,
                  type: "button",
                  disabled: !vue.unref(enableMonthArrow) || vue.unref(dateRangeDisabled),
                  class: vue.normalizeClass([[
                    vue.unref(ppNs).e("icon-btn"),
                    vue.unref(ppNs).is("disabled", !vue.unref(enableMonthArrow) || vue.unref(dateRangeDisabled))
                  ], "arrow-right"]),
                ...
                vue.createElementVNode("div", null, [
                  ...
                  }, vue.toDisplayString(vue.unref(leftYearLabel)), 43, ["tabindex", "aria-disabled", "onKeydown", "onClick"]),
                  ...
                  }, vue.toDisplayString(vue.unref(t)(`el.datepicker.month${leftDate.value.month() + 1}`)), 43, ["tabindex", "aria-disabled", "onKeydown", "onClick"]), [
                    [vue.vShow, vue.unref(leftCurrentView) === "date"]
                  ])
                ])
              ], 2),
            ...
            vue.createElementVNode("div", {
              ...
              vue.createElementVNode("div", {
                ...
                vue.createElementVNode("div", null, [
                  ...
                  }, vue.toDisplayString(vue.unref(rightYearLabel)), 43, ["tabindex", "aria-disabled", "onKeydown", "onClick"]),
                  vue.withDirectives(vue.createElementVNode("span", {
                    role: "button",
                    "aria-live": "polite",
                    tabindex: _ctx.disabled ? void 0 : 0,
                  ...
                  }, vue.toDisplayString(vue.unref(t)(`el.datepicker.month${rightDate.value.month() + 1}`)), 43, ["tabindex", "aria-disabled", "onKeydown", "onClick"]), [
                    [vue.vShow, vue.unref(rightCurrentView) === "date"]
                  ])
                ])
              ], 2),
