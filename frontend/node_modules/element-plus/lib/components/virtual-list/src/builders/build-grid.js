...
const createGrid = ({
  ...
  return vue.defineComponent({
    ...
    setup(props, { emit, expose, slots }) {
      ...
      const { touchStartX, touchStartY, handleTouchStart, handleTouchMove } = useGridTouch.useGridTouch(windowRef, states, scrollTo, estimatedTotalWidth, estimatedTotalHeight, parsedWidth, parsedHeight);
