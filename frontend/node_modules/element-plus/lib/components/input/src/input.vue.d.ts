...
declare const __VLS_component: import("vue").DefineComponent<{
    ...
    readonly type: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => string) | (() => import("./input").InputType) | ((new (...args: any[]) => string) | (() => import("./input").InputType))[], unknown, unknown, "text", boolean>;
    readonly resize: {
    ...
    readonly id: string;
    readonly type: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => string) | (() => import("./input").InputType) | ((new (...args: any[]) => string) | (() => import("./input").InputType))[], unknown, unknown>;
