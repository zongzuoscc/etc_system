  ...
  return openBlock(), createBlock(_component_el_tooltip, {
    ...
    content: withCtx(() => [
      _ctx.multiple ? (openBlock(), createElementBlock("div", {
        ...
        }, toDisplayString(_ctx.t("el.table.clearFilter")), 11, ["tabindex", "aria-checked", "onClick"]),
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.filters, (filter, idx) => {
          ...
          }, toDisplayString(filter.text), 11, ["tabindex", "aria-checked", "onClick"]);
        }), 128))
      ], 42, ["onKeydown"]))
    ]),
    default: withCtx(() => {
